        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Tambah Pengeluaran BKU</h4>
                            </div>
                            <div class="content">
                                <form method="post" action="aksi_pengeluaran.php">
                                    ...
                                    <div class="row">
                                     ...
                                     <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Nilai</label>
                                                <input type="number" placeholder="Rp." class="form-control" name="keluar" min="0">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
